...
public:
		...
		: entry::AppI(_name, _description, _url)
	{
		...
		bx::simd128_t neon0 = bx::simd_min(a,b);
		bx::simd128_t neon1 = bx::simd_min(b,a);
		bx::simd128_t neon2 = bx::simd_max(a,b);
		bx::simd128_t neon3 = bx::simd_max(b,a);

		BX_UNUSED(neon0, neon1, neon2, neon3);
	}
